...
public class ColumnParserTest {
    ...
    public void testIntegrationTestOfParserWithFootball() {
        ...
        assertEquals(new Football("Arsenal", 79, 36), DataKata.footballParserBuilder.parseWith(Football::new).apply(s));
    }

    @Test
    public void testIntegrationTestOfParserWithWeather() {
        String s = "   6  81    61    71          63.7       0.00 RFH     030  6.2 030  13  9.7  93 60 1012.7";
        assertEquals(new Weather(6, 81, 61), DataKata.weatherParserBuilder.parseWith(Weather::new).apply(s));
    }
}
